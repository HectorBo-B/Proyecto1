    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
    {
        ...
        switch (tipo)
        {
            ...
            case "chequesPendientes":
                ChequeDAO chequePendienteDAO = new ChequeDAO();
                List<Cheque> pendientes = chequePendienteDAO.listarPorEstado(2);
                request.setAttribute("cheques", pendientes);
                request.setAttribute("reporteTipo", "chequesPendientes");
                request.getRequestDispatcher("reportes.jsp").forward(request, response);
                break;
