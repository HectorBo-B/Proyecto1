...
public class ConciliacionDAO
{
    ...
    public boolean crear(Conciliacion conciliacion)
    {
        ...
        String sql = "INSERT INTO conciliaciones (periodo, saldo_libros, depositos_transito, "
        ...
        try
        {
            Connection conn = Conexion.getInstance().getConnection();
            PreparedStatement ps = conn.prepareStatement(sql);
            ps.setString(1, conciliacion.getPeriodo());
            ps.setBigDecimal(2, conciliacion.getSaldoLibros());
            ps.setBigDecimal(3, conciliacion.getDepositosTransito());
            ps.setBigDecimal(4, conciliacion.getChequesPendientes());
            ps.setBigDecimal(5, conciliacion.getSaldoBanco());
            ps.setBigDecimal(6, conciliacion.getDiferencia());
            ps.setInt(7, conciliacion.getEstado());
            ps.setInt(8, conciliacion.getIdUsuario());
            ps.setString(9, conciliacion.getObservaciones());
