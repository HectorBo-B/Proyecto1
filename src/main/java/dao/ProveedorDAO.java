...
public class ProveedorDAO
{
    ...
    {
        List<Proveedor> lista = new ArrayList<>();
        String sql = "SELECT * FROM proveedores WHERE estado = 1 ORDER BY nombre";
    ...
    public boolean crear(Proveedor proveedor)
    {
        ...
        String sql = "INSERT INTO proveedores (nombre, telefono, correo, estado, ruc) VALUES (?, ?, ?, ?, ?)";
    ...
    {
        List<Proveedor> lista = new ArrayList<>();
        String sql = "SELECT * FROM proveedores WHERE nombre LIKE ? OR ruc LIKE ? ORDER BY nombre";
