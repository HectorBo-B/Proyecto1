    ...
    public boolean crear(ObjetoGasto objeto)
{
    ...
    String sql = "INSERT INTO objeto_gasto (codigo, descripcion, estado) VALUES (?, ?, ?)";
    
    System.out.println("=== CREANDO OBJETO DE GASTO ===");
    System.out.println("Código: " + objeto.getCodigo());
    ...
    try
    {
        ...
        {
            creado = true;
            System.out.println("✅ INSERT exitoso en objeto_gasto");
        }
        else
        {
